...
|---|---|---|---|---|---|---|
| **Delhi** | May 25 → Jul 26 | 42 → 127, post-monsoon burning | 33.4 → 99.0 | 39<!--fig:delhi.weeks--> | 9<!--fig:delhi.retrains--> | 8<!--fig:delhi.promotions--> |
| **Santiago** | Oct 25 → Jul 26 | 18 → 94, winter inversion in a basin | 6.2 → 68.3 | 21<!--fig:santiago.weeks--> | 13<!--fig:santiago.retrains--> | 7<!--fig:santiago.promotions--> |
| **Kraków** | May 25 → Jul 26 | 8 → 57, winter smog in a basin | 5.1 → 54.5 | 48<!--fig:krakow.weeks--> | 14<!--fig:krakow.retrains--> | 7<!--fig:krakow.promotions--> |
| **Johannesburg** | Nov 25 → Jul 26 | 23 → 87, Highveld coal smoke | 12.0 → 82.3 | 19<!--fig:joburg.weeks--> | 11<!--fig:joburg.retrains--> | 3<!--fig:joburg.promotions--> |
| **Melbourne** | Sep 25 → Jul 26 | 5 → 15, winter wood heaters | 3.8 → 15.0 | 30<!--fig:melbourne.weeks--> | 8<!--fig:melbourne.retrains--> | 4<!--fig:melbourne.promotions--> |
| **Los Angeles** | Sep 25 → Jul 26 | 15 → 29, a mild winter bump | 16.4 → 20.8 | 36<!--fig:la.weeks--> | 1<!--fig:la.retrains--> | 1<!--fig:la.promotions--> |
...
|---|---|---|---|
| **Delhi** | +43.7% [+28.7, +64.2]<!--fig:delhi.replay--> | **+49.4% [+33.7, +61.8]**<!--fig:delhi.acted--> | 92% [79, 97]<!--fig:delhi.won--> of 38<!--fig:delhi.acted.n--> |
| **Santiago** | +16.8% [−0.0, +42.5]<!--fig:santiago.replay--> | **+17.3% [+9.0, +37.0]**<!--fig:santiago.acted--> | 100% [81, 100]<!--fig:santiago.won--> of 16<!--fig:santiago.acted.n--> |
| **Kraków** | +0.2% [−57.2, +35.5]<!--fig:krakow.replay--> | +6.5% [−15.3, +27.5]<!--fig:krakow.acted--> | 72% [58, 83]<!--fig:krakow.won--> of 47<!--fig:krakow.acted.n--> |
| **Johannesburg** | −0.0% [−0.0, +21.3]<!--fig:joburg.replay--> | **+14.9% [+8.7, +21.4]**<!--fig:joburg.acted--> | 100% [61, 100]<!--fig:joburg.won--> of 6<!--fig:joburg.acted.n--> |
| **Melbourne** | +0.1% [−3.1, +6.5]<!--fig:melbourne.replay--> | +1.2% [−0.6, +3.0]<!--fig:melbourne.acted--> | 70% [52, 84]<!--fig:melbourne.won--> of 27<!--fig:melbourne.acted.n--> |
| **Los Angeles** | −7.9% [−29.1, +0.4]<!--fig:la.replay--> | **−13.4% [−36.9, −3.8]**<!--fig:la.acted--> | 29% [16, 45]<!--fig:la.won--> of 35<!--fig:la.acted.n--> |
...
and holds at every block length. Santiago's and Johannesburg's are real. And **Los Angeles's −13.4%<!--fig:la.acted-->
...
large city effects, Delhi's +49.4%<!--fig:delhi.acted--> and Santiago's +17.3%<!--fig:santiago.acted-->, sit nowhere near the
...
its paired result falls from −2.8% to −13.4%<!--fig:la.acted-->. That is the control city getting
...
The paired reading tells the same story more quietly, +4.5% against +49.4%<!--fig:delhi.acted--> in
...
|---|---|---|---|---|
| **Kraków** | skill < 0 | 30<!--fig:floor.krakow.+0.00.differing--> of 47 | +0.00% [−11.48, +0.00]<!--fig:floor.krakow.+0.00.all--> | −10.82% [−19.47, +1.77]<!--fig:floor.krakow.+0.00.acted--> |
| **Kraków** | skill < −0.25 | 17<!--fig:floor.krakow.-0.25.differing--> of 47 | +0.00% [−4.96, +0.00]<!--fig:floor.krakow.-0.25.all--> | **−23.98% [−39.40, −5.48]**<!--fig:floor.krakow.-0.25.acted--> |
| **Kraków** | skill < −0.5 | 0 | identical | — |
| **Delhi** | skill < 0 | 24<!--fig:floor.delhi.+0.00.differing--> of 38 | +0.00% [−6.73, +0.00]<!--fig:floor.delhi.+0.00.all--> | −5.29% [−15.14, +2.31]<!--fig:floor.delhi.+0.00.acted--> |
| **Delhi** | skill < −0.25 | 18<!--fig:floor.delhi.-0.25.differing--> of 38 | +0.00% [−6.73, +0.00]<!--fig:floor.delhi.-0.25.all--> | **−9.05% [−15.82, −4.44]**<!--fig:floor.delhi.-0.25.acted--> |
| **Delhi** | skill < −0.5 | 0 | identical | — |
| **Santiago** | skill < 0 | 6<!--fig:floor.santiago.+0.00.differing--> of 20 | +0.00% [+0.00, +0.65]<!--fig:floor.santiago.+0.00.all--> | **+3.42% [+0.19, +6.72]**<!--fig:floor.santiago.+0.00.acted--> |
| **Los Angeles** | skill < 0 | 31<!--fig:floor.la.+0.00.differing--> of 35 | **+11.45% [+1.04, +17.22]**<!--fig:floor.la.+0.00.all--> | **+11.78% [+2.89, +18.38]**<!--fig:floor.la.+0.00.acted--> |
| **Los Angeles** | skill < −0.25 | 31<!--fig:floor.la.-0.25.differing--> of 35 | **+10.26% [+0.44, +16.35]**<!--fig:floor.la.-0.25.all--> | **+11.48% [+2.09, +17.29]**<!--fig:floor.la.-0.25.acted--> |
| **Los Angeles** | skill < −0.5 | 25<!--fig:floor.la.-0.50.differing--> of 35 | +2.49% [+0.00, +15.01]<!--fig:floor.la.-0.50.all--> | **+11.78% [+2.09, +17.17]**<!--fig:floor.la.-0.50.acted--> |
...
|---|---|---|---|---|
| under 20 weeks | 25<!--fig:gate.short.n--> | +12.4% [+9.2, +16.9]<!--fig:gate.short.exam--> | **+9.8% [+6.4, +14.0]**<!--fig:gate.short.delivered--> | 0 / 25 [0%, 13%] |
| 20 weeks or more | 3<!--fig:gate.long.n--> | +14.4%<!--fig:gate.long.exam-->, unbounded | **−6.1%**<!--fig:gate.long.delivered-->: −8.0%, −6.7%, −3.6% | 3 / 3 [44%, 100%] |
...
- Los Angeles's single promotion, which produces its entire −13.4%<!--fig:la.acted--> retraining
...
them would take Los Angeles from −13.4%<!--fig:la.acted--> toward zero. It does not: Los Angeles
...
|---|---|---|---|---|---|
| **Delhi** | Ridge, shipped | 40.44<!--fig:ablation.delhi.ridge.rmse--> | 9 | 8 | **+49.35% [+33.74, +61.81]**<!--fig:ablation.delhi.ridge--> |
| **Delhi** | Ridge, tuned | 40.11<!--fig:ablation.delhi.ridge_tuned.rmse--> | 8 | 8 | **+27.73% [+14.99, +40.59]**<!--fig:ablation.delhi.ridge_tuned--> |
| **Delhi** | gradient boosting, tuned | **39.91**<!--fig:ablation.delhi.gbm_tuned.rmse--> | 7 | 5 | **+9.74% [+7.97, +25.96]**<!--fig:ablation.delhi.gbm_tuned--> |
| **Los Angeles** | Ridge, shipped | 10.91<!--fig:ablation.la.ridge.rmse--> | 1 | 1 | **−13.36% [−36.88, −3.81]**<!--fig:ablation.la.ridge--> |
| **Los Angeles** | Ridge, tuned | 10.76<!--fig:ablation.la.ridge_tuned.rmse--> | 1 | 1 | **−12.78% [−33.58, −3.28]**<!--fig:ablation.la.ridge_tuned--> |
| **Los Angeles** | gradient boosting, tuned | **10.74**<!--fig:ablation.la.gbm_tuned.rmse--> | 1 | 1 | −6.93% [−13.20, +2.83]<!--fig:ablation.la.gbm_tuned--> |
...
**Delhi's premium falls from +49.35%<!--fig:ablation.delhi.ridge--> to +9.74%<!--fig:ablation.delhi.gbm_tuned-->.** Over the 37 weeks both arms
...
**Los Angeles's harm falls from −13.36%<!--fig:ablation.la.ridge--> to −6.93%<!--fig:ablation.la.gbm_tuned--> and stops clearing zero.** The
...
| Delhi's +49.35%<!--fig:ablation.delhi.ridge--> | points |
|---|---|
| lost by tuning `alpha`, same model class | **21.62**<!--fig:ablation.delhi.alpha_points--> |
| lost by leaving linearity | **17.99**<!--fig:ablation.delhi.linearity_points--> |
| **left over** | **+9.74%**<!--fig:ablation.delhi.gbm_tuned--> |
...
pays in Delhi with the best model on offer, +9.74% [+7.97, +25.96]<!--fig:ablation.delhi.gbm_tuned-->, clear of
...
−6.93% [−13.20, +2.83]<!--fig:ablation.la.gbm_tuned--> with a tuned tree, which does not clear zero. "Retraining
...
|---|---|---|---|---|---|
| **Delhi** | +49.4% [+33.7, +61.8]<!--fig:rebaseline.delhi.shipped--> | **+22.8% [+11.8, +36.4]**<!--fig:rebaseline.delhi.fixed--> | 40.44<!--fig:rebaseline.delhi.shipped.rmse--> → 40.11<!--fig:rebaseline.delhi.fixed.rmse--> | 9<!--fig:rebaseline.delhi.shipped.fires--> → 8<!--fig:rebaseline.delhi.fixed.fires--> of 39 | 21w<!--fig:rebaseline.delhi.shipped.silence--> → 21w<!--fig:rebaseline.delhi.fixed.silence--> |
| **Santiago** | +17.3% [+9.0, +37.0]<!--fig:rebaseline.santiago.shipped--> | +17.5% [+8.6, +37.1]<!--fig:rebaseline.santiago.fixed--> | 24.54<!--fig:rebaseline.santiago.shipped.rmse--> → 24.55<!--fig:rebaseline.santiago.fixed.rmse--> | 13<!--fig:rebaseline.santiago.shipped.fires--> → 13<!--fig:rebaseline.santiago.fixed.fires--> of 21 | 3w<!--fig:rebaseline.santiago.shipped.silence--> → 3w<!--fig:rebaseline.santiago.fixed.silence--> |
| **Johannesburg** | +14.9% [+8.7, +21.4]<!--fig:rebaseline.joburg.shipped--> | **+9.7% [+4.6, +14.0]**<!--fig:rebaseline.joburg.fixed--> | 21.13<!--fig:rebaseline.joburg.shipped.rmse--> → 21.72<!--fig:rebaseline.joburg.fixed.rmse--> | 11<!--fig:rebaseline.joburg.shipped.fires--> → 12<!--fig:rebaseline.joburg.fixed.fires--> of 19 | 3w<!--fig:rebaseline.joburg.shipped.silence--> → 3w<!--fig:rebaseline.joburg.fixed.silence--> |
| **Kraków** | +6.5% [−15.3, +27.5]<!--fig:rebaseline.krakow.shipped--> | +5.7% [−14.8, +26.8]<!--fig:rebaseline.krakow.fixed--> | 17.49<!--fig:rebaseline.krakow.shipped.rmse--> → 17.49<!--fig:rebaseline.krakow.fixed.rmse--> | 14<!--fig:rebaseline.krakow.shipped.fires--> → 21<!--fig:rebaseline.krakow.fixed.fires--> of 48 | **30w<!--fig:rebaseline.krakow.shipped.silence--> → 22w<!--fig:rebaseline.krakow.fixed.silence-->** |
| **Melbourne** | +1.2% [−0.6, +3.0]<!--fig:rebaseline.melbourne.shipped--> | **+5.6% [+2.0, +6.6]**<!--fig:rebaseline.melbourne.fixed--> | 3.97<!--fig:rebaseline.melbourne.shipped.rmse--> → 4.01<!--fig:rebaseline.melbourne.fixed.rmse--> | 8<!--fig:rebaseline.melbourne.shipped.fires--> → 9<!--fig:rebaseline.melbourne.fixed.fires--> of 30 | 15w<!--fig:rebaseline.melbourne.shipped.silence--> → 15w<!--fig:rebaseline.melbourne.fixed.silence--> |
| **Los Angeles** | −13.4% [−36.9, −3.8]<!--fig:rebaseline.la.shipped--> | **−3.5% [−25.6, +3.0]**<!--fig:rebaseline.la.fixed--> | 10.91<!--fig:rebaseline.la.shipped.rmse--> → 10.21<!--fig:rebaseline.la.fixed.rmse--> | **1<!--fig:rebaseline.la.shipped.fires--> → 7<!--fig:rebaseline.la.fixed.fires--> of 36** | **35w<!--fig:rebaseline.la.shipped.silence--> → 16w<!--fig:rebaseline.la.fixed.silence-->** |
...
- **The model-class confound was real, and this bullet said otherwise until
  ...
  Delhi's +49.4%<!--fig:delhi.acted--> is 21.6 points<!--fig:ablation.delhi.alpha_points--> of shipped `alpha`, 18.0 points<!--fig:ablation.delhi.linearity_points--> of linearity and
  +9.7%<!--fig:ablation.delhi.gbm_tuned--> left over, and the re-baseline through the loop puts the surviving
  premium at +22.8% [+11.8, +36.4]<!--fig:rebaseline.delhi.fixed-->. The confound is measured, not closed: the
